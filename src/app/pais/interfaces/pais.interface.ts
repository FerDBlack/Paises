...
//
//   const respCountriesType = Convert.toRespCountriesType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface RespCountriesType {
  name:         Name;
  tld:          string[];
  cca2:         string;
  ccn3:         string;
...
export class Convert {
  public static toRespCountriesType(json: string): RespCountriesType[] {
    return cast(JSON.parse(json), a(r("RespCountriesType")));
  }

  public static respCountriesTypeToJson(value: RespCountriesType[]): string {
    return JSON.stringify(uncast(value, a(r("RespCountriesType"))), null, 2);
  }
}
